...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('vpn', '0007_alter_ownercontactdetails_name'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='device',
            name='name',
            field=models.CharField(choices=[('Andriod', 'Andriod'), ('iPhone&iPad', 'iPhone&iPad'), ('Mac', 'Mac'), ('Routers', 'Routers'), ('Pc', 'Pc'), ('Windows', 'Windows')], max_length=200, unique=True),
        ),
        migrations.AlterField(
            model_name='faq',
            name='Question',
        ...
        migrations.AlterField(
            model_name='feature',
            name='category',
            field=models.CharField(choices=[('Privacy', 'Privacy'), ('Speed', 'Speed'), ('security', 'Security'), ('Newbies', 'Newbies')], default=1, max_length=200, unique=True),
        ),
        migrations.AlterField(
            model_name='form',
            name='email',
        ...
        migrations.AlterField(
            model_name='ownercontactdetails',
            name='name',
            field=models.CharField(choices=[('admin', 'admin'), ('user1', 'user1'), ('user2', 'user2')], default='', max_length=200, unique=True),
        ),
        migrations.AlterField(
            model_name='remark',
            name='remarks',
        ...
        migrations.AlterField(
            model_name='service',
            name='name',
            field=models.CharField(choices=[['Overall Best Vpn of 2023', 'Overall Best Vpn of 2023']], max_length=200, unique=True),
        ),
        migrations.AlterField(
