...
from .view import Top_10_without_id,Top_10_with_id,Vpn_with_id,Instruction,Vpn_without_id,All_avilable_filter_with_id,All_avilable_filter_without_id,get_logo_url,Form_without_id
urlpatterns =[
