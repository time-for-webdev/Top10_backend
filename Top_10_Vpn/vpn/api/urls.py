...
from .view import Vpn_with_id,Instruction,Vpn_without_id,get_logo_url,Form_without_id,Specification_without_id,DeviceWithoutId,DeviceWithId,LocationWithId,LocationWithoutId,ServiceWithId,ServiceWithoutId,FAQ_without_id,OwnerContactDetails_without_id,LastUpdateDate_without_id
...
urlpatterns =[
    ...
    path('last_update_time/',LastUpdateDate_without_id,name='LastUpdateDate_without_id'),
